...
public class GetNextUserDataExtCommand implements Command {
    ...
    public String sender(TraceInfo traceInfo) {
        log.info("SENDER/GetNextUserDataExt:::{}", traceInfo);
        GetUserDataRequest response = GetUserDataRequest.builder().request("GetNextUserDataExt")
        ...
        try {
            ...
            log.error("Error in send response for GetNextUserDataExt:", e);
